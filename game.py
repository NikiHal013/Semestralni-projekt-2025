...
from scripts.particle import Patricle
        ...
        while True:
            ...
            for rect in self.leaf_spawners:
                if random.random() * 49999 < rect.width * rect.height: #spawn chance based on area
                    ...
                    self.particles.append(Patricle(self, "leaf", pos, velocity=[-0.1,0.3], frame=random.randint(0, 20))) #random starting frame for variety

...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption("Corebound - Beta")
        ...
        self.display = pygame.Surface((self.screen.get_width() // self.pixel_scale, self.screen.get_height() // self.pixel_scale))
        ...
        self.load_level(0) #load default map
        ...
        while True:
            ...
            for event in pygame.event.get(): #event handling
                ...
                if event.type == pygame.VIDEORESIZE:
                    new_w = max(160, event.w)
                    new_h = max(120, event.h)
